...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public List<ToDoModel> getAllTasks() {
            ...
            if (cur != null) {
                if (cur.moveToFirst()) {
                    ...
                    do {
                        ...
                        // Check if the column index is valid (not -1) before using it else this throws error
                        if (idColumnIndex != -1) {
        ...
        public void updateStatus(int id,int status){
            ...
            db.update(TODO_TABLE,cv,ID+"=?",new String[]{String.valueOf(id)});//same as prepared statement in JDBC
        }
        ...
        public void deleteTask(int id){
            db.delete(TODO_TABLE,ID+"=?",new String[]{String.valueOf(id)});//same as prepared statement in JDBC
        }
    }
